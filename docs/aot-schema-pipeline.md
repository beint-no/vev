...
- permanent logged nonpartitioned non-inherited built-in heap tables, with no rewrite rules, check constraints, unique secondary indexes, or undeclared indexes touching a mapped table;
