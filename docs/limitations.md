...
- Explicit integer identity creation is supported through generated input records; see [generated identifiers](generated-identifiers.md). Shared sequences expose allocation progression, have gaps, and cannot provide gapless business numbering. Single-column identity primary keys remain unsupported.
