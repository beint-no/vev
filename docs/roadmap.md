...
- implement generated check constraints and extend the verified tenant-scoped unique constraints and immediate scalar references without weakening database integrity;
