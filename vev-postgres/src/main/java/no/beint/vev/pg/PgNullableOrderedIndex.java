...
/**
 * Generated index token for a nullable scalar component, including a compile-time-safe {@code IS NULL} query seam.
 *
 ...
 */
public final class PgNullableOrderedIndex<M, E, K, V, S> implements PgOrderedIndex<M, E, K, V, S> {
